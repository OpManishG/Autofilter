...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5398452170').split()]
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001642123180')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://imdvstram:imdvstram@cluster0.8cwo74r.mongodb.net/?retryWrites=true&w=majority")
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴛʜᴀɴᴋꜱ ᴛᴏ ᴄʀᴀᴢʏ')
