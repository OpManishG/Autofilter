...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @LazyDeveloperr
        ...
        buttons = [[
            InlineKeyboardButton('ᴍ ꜰɪʟᴛᴇʀ', callback_data='manuelfilter'),
            InlineKeyboardButton('ᴀ ꜰɪʟᴛᴇʀ', callback_data='autofilter')
        ],[
        ...
        buttons = [[ 
             ...
             InlineKeyboardButton('♻️  ᴍᴏʀᴇ ꜰᴇᴀᴛᴜʀᴇꜱ  ♻️', callback_data='more_feature'), 
         ], [ 
         ], [             
